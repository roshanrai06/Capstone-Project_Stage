package com.roshanrai.filmophile.model.dao.impl;
...
public class MovieCheckContentProvider extends ContentProvider {
    ...
    public static final String PROVIDER_NAME = "com.roshanrai.filmophile.model.dao.contentprovider.moviecheckcontentprovider";
    ...
    public String getType(Uri uri) {
        switch (uriMatcher.match(uri)) {
            case CODE_MOVIE:
                return "vnd.android.cursor.dir/vnd.roshanrai.filmophile.model.entity.movie";
            case CODE_USER:
                return "vnd.android.cursor.dir/vnd.roshanrai.filmophile.model.entity.user";
            case CODE_MOVIE_INTEREST:
                return "vnd.android.cursor.dir/vnd.roshanrai.filmophile.model.entity.movieinterest";
            case CODE_MOVIE_NOT_INTEREST:
                return "vnd.android.cursor.dir/vnd.roshanrai.filmophile.model.entity.movienotinterest";
            case CODE_MOVIE_WATCHED:
                return "vnd.android.cursor.dir/vnd.roshanrai.filmophile.model.entity.moviewatched";
        }
        throw new IllegalArgumentException("Unsupported URI for insertion: " + uri);
    }
