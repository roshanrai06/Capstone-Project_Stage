...
import com.roshanrai.filmophile.dagger.SearchViewModule;
...
import com.roshanrai.filmophile.view.adapter.MovieListAdapter;
import com.roshanrai.filmophile.view.adapter.OnItemClickListener;
import com.roshanrai.filmophile.view.adapter.PersonListAdapter;
...
public class SearchActivity extends AppCompatActivity implements com.roshanrai.filmophile.view.SearchView {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new SearchViewModule(this)).inject(this);
        ButterKnife.bind(this);
        defaultTracker = ((FilmophileApplication) getApplication()).getDefaultTracker();
