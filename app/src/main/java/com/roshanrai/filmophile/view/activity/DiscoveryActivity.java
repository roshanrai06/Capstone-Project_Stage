...
import com.roshanrai.filmophile.dagger.DiscoveryViewModule;
...
public class DiscoveryActivity extends AppCompatActivity implements DiscoveryView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new DiscoveryViewModule(this)).inject(this);
