...
import com.roshanrai.filmophile.dagger.HomeViewModule;
...
import com.roshanrai.filmophile.util.PicassoCircleTransform;
import com.roshanrai.filmophile.view.HomeView;
import com.roshanrai.filmophile.view.adapter.MovieListAdapter;
import com.roshanrai.filmophile.view.adapter.NowPlayingMovieListAdapter;
...
import com.roshanrai.filmophile.view.adapter.UpcomingMovieListAdapter;
...
public class HomeActivity extends AppCompatActivity implements HomeView, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new HomeViewModule(this)).inject(this);
