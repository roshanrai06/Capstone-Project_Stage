...
import com.roshanrai.filmophile.dagger.SearchMovieViewModule;
...
public class SearchMovieActivity extends AppCompatActivity implements SearchMovieView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new SearchMovieViewModule(this)).inject(this);
