...
import com.roshanrai.filmophile.dagger.UserProfileViewModule;
...
public class UserProfileActivity extends AppCompatActivity implements UserProfileView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new UserProfileViewModule(this)).inject(this);
