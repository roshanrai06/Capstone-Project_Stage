...
import com.roshanrai.filmophile.dagger.PersonProfileViewModule;
...
public class PersonProfileActivity extends AppCompatActivity implements PersonProfileView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new PersonProfileViewModule(this)).inject(this);
