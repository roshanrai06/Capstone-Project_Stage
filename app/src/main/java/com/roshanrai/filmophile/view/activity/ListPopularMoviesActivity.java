...
import com.roshanrai.filmophile.dagger.ListPopularMoviesViewModule;
...
public class ListPopularMoviesActivity extends AppCompatActivity implements ListPopularMoviesView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new ListPopularMoviesViewModule(this)).inject(this);
    ...
    protected void onResume() {
        ...
        defaultTracker.setScreenName("List Of Popular Movies Screen");
