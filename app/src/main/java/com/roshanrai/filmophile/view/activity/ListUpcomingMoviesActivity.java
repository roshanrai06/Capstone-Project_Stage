...
import com.roshanrai.filmophile.dagger.ListUpcomingMoviesViewModule;
...
public class ListUpcomingMoviesActivity extends AppCompatActivity implements ListUpcomingMoviesView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new ListUpcomingMoviesViewModule(this)).inject(this);
