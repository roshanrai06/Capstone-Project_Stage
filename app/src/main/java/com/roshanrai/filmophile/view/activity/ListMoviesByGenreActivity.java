...
import com.roshanrai.filmophile.dagger.ListMoviesByGenreViewModule;
...
public class ListMoviesByGenreActivity extends AppCompatActivity implements ListMoviesByGenreView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new ListMoviesByGenreViewModule(this)).inject(this);
