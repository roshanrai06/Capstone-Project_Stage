...
import com.roshanrai.filmophile.dagger.ListNowPlayingMoviesViewModule;
...
public class ListNowPlayingMoviesActivity extends AppCompatActivity implements ListNowPlayingMoviesView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new ListNowPlayingMoviesViewModule(this)).inject(this);
