...
import com.roshanrai.filmophile.dagger.MovieProfileViewModule;
...
public class MovieProfileActivity extends AppCompatActivity implements MovieProfileView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new MovieProfileViewModule(this)).inject(this);
