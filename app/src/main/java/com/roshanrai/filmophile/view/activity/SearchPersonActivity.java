...
import com.roshanrai.filmophile.dagger.SearchPersonViewModule;
...
public class SearchPersonActivity extends AppCompatActivity implements SearchPersonView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((FilmophileApplication) getApplication()).getObjectGraph().plus(new SearchPersonViewModule(this)).inject(this);
    ...
    protected void onResume() {
        ...
        defaultTracker.setScreenName("Search Person Screen");
